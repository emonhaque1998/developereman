"use client";
import { noxfolioSlider } from "@/Components/utility/sliderProps";
                            ...
                            <div className="col-lg-4">
                                <div className="testimonials-content-part rel z-2 rmb-55 wow fadeInUp delay-0-2s">
                                    <div className="section-title mb-40">
                                        ...
                                        <p>
                                            Sed ut perspiciatis unde omnin natus
                            ...
                            <div className="col-lg-8">
                                ...
                                >
                                    ...
                                    <div className="testimonial-item wow fadeInUp delay-0-4s">
                                        ...
                                        <div className="text">
                                            Nam libero tempore cumsoluta nobise
                                            est eligendi optio cumque nihil
                                            impedit quominus idquod maxime
