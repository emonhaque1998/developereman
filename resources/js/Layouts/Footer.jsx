        ...
        <footer className="main-footer rel z-1">
            ...
            <div className="footer-bottom pt-20 pb-5 rpt-25">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="copyright-text">
                                <p>
                                    Copyright @{date},{" "}
                                    <Link href="/">Noxfolio</Link> All Rights
                                    Reserved
                                </p>
                            </div>
                        </div>
                    ...
                    <a
                        href="#"
                        className="scroll-top scroll-to-target d-inline-block"
                    >
            ...
            <div className="footer-bottom pt-10 pb-15">
                <div className="container">
                    <div className="copyright-text text-center">
                        <p>
                            Copyright @{date}, <Link href="/">Noxfolio</Link>{" "}
                            All Rights Reserved
                        </p>
                    </div>
                </div>
